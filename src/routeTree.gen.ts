...
const AuthenticatedDashResumesIndexRoute =
  AuthenticatedDashResumesIndexRouteImport.update({
    id: '/dash/resumes/',
    path: '/dash/resumes/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
const AuthenticatedDashConnectionsIndexRoute =
  AuthenticatedDashConnectionsIndexRouteImport.update({
    id: '/dash/connections/',
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/dash/resumes/': {
      id: '/_authenticated/dash/resumes/'
      path: '/dash/resumes'
      fullPath: '/dash/resumes'
      preLoaderRoute: typeof AuthenticatedDashResumesIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/dash/connections/': {
      id: '/_authenticated/dash/connections/'
      path: '/dash/connections'
