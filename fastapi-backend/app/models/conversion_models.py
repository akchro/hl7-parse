...
class SaveConversionRequest(BaseModel):
    ...
    plain_english: Optional[str] = Field(None, description="Plain English medical document")
    ...
    patient_name: Optional[str] = Field(None, max_length=200, description="Patient name for filtering")
